...
public class CharacterManager {	
	...
	public static void printCharacter(ResultSet rs) throws SQLException {
		Character character = getCharacter(rs);

		System.out.println(character.getId() + " " + character.getFname() + " " + 
				character.getLname() + " " + character.getExperience() + " " +
				character.getLevel() + " " + character.getRace() + " " + 
				character.getClassId() + " " + character.getBirthDate());
	}
