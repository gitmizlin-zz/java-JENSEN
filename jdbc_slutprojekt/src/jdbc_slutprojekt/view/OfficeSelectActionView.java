...
public class OfficeSelectActionView extends JFrame {
	...
	public OfficeSelectActionView(String title, ResultSet rs, Connection conn) throws SQLException {
		super(title);

		OfficeManager om = new OfficeManager(conn);
