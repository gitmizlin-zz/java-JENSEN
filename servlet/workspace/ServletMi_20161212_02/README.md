Project name: ServletMi_20161212_02
...
How to add Tomcat Server in Eclipse: Windows -> Show View -> Servers . In the servers view, right-click and add new. Then you will get a pop-up with several server vendors. Select Tomcat v8.0 under Apache (Depending on the server version you download). Then in the runtime configuration, point it to the downloaded Tomcat folder.
