...
<jsp:useBean id="sampleHelloWorldImplProxyid" scope="session" class="com.jensen.HelloWorldImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.jensen.HelloWorldImpl getHelloWorldImpl10mtemp = sampleHelloWorldImplProxyid.getHelloWorldImpl();
...
case 13:
        gotMethod = true;
        java.lang.String sayHello13mtemp = sampleHelloWorldImplProxyid.sayHello();
